...
MARCH_2015=$(jq -r '.prices[][]' ./quotes.json |
awk 'ORS=NR%2?" ":"\n"' | 
...
MARCH_2016=$(jq -r '.prices[][]' ./quotes.json |
awk 'ORS=NR%2?" ":"\n"' |
...
MARCH_2017=$(jq -r '.prices[][]' ./quotes.json |
awk 'ORS=NR%2?" ":"\n"' |
...
MARCH_2018=$(jq -r '.prices[][]' ./quotes.json |
awk 'ORS=NR%2?" ":"\n"' |
...
MARCH_2019=$(jq -r '.prices[][]' ./quotes.json |
awk 'ORS=NR%2?" ":"\n"' |
...
MARCH_2020=$(jq -r '.prices[][]' ./quotes.json |
awk 'ORS=NR%2?" ":"\n"' | 
